...
`forkOldCRAN` allows you to create a github repository for an older version of a cran package which can be followed up by `install_github` or `Remotes`
in your DESCRIPTION file if you really need an older version to make things work.
